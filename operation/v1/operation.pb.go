...
const file_operation_v1_operation_proto_rawDesc = "" +
	"\n" +
	"\x1coperation/v1/operation.proto\x12\x10api.operation.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\x9b\x01\n" +
	...
	"\bappealID\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\bappealID\x12!\n" +
	"\x06status\x18\x02 \x01(\x05B\t\xfaB\x06\x1a\x040\x140\x1eR\x06status2\xf9\x01\n" +
	"\tOperation\x12u\n" +
	"\vAuditReview\x12$.api.operation.v1.AuditReviewRequest\x1a\".api.operation.v1.AuditReviewReply\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11o/v1/review/audit\x12u\n" +
	"\vAuditAppeal\x12$.api.operation.v1.AuditAppealRequest\x1a\".api.operation.v1.AuditAppealReply\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11o/v1/appeal/auditB2\n" +
